...
public class StudentDaoTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("학생 등록 조회 : " + dao.selectOne(dto.getStuno()));
		...
		try {
			...
			System.out.println("학생 정보 수정 " + count + " 건 수정 성공!!");
		...
		try {
			...
			System.out.println("학생 정보 삭제 " + count + " 건 성공!!");
